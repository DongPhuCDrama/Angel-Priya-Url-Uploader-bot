...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6443004679:AAEYqctJm8b4di4wWjTjqchau00M_IaXAeU"))
    # The Telegram API things
    APP_ID = int(os.environ.get("APP_ID", "23407106"))
    API_HASH = os.environ.get("API_HASH", "34817fe096f567f55ce37750b8a5ff1b"))
    # Get these values from my.telegram.org
    # Array to store users who are authorized to use the bot
    AUTH_USERS = set(int(x) for x in os.environ.get("AUTH_USERS", "1484670284 5624455510").split())
    ...
    LAZY_DEVELOPER = set(int(x) for x in os.environ.get("LAZY_ADMIN", "1484670284")).split())
